export const gameCenterPolicy = {
  catalogLimit: 50,
  maximumCachedGames: 200,
  paginationTriggerRemainingItems: 4,
} as const;

/** Native `.profile` cache policy used by both GameCenterStore lists. */
export const gameCenterCachePolicy = {
  ttlMilliseconds: 10 * 60 * 1_000,
  staleRetentionMilliseconds: 90 * 24 * 60 * 60 * 1_000,
} as const;

/** Source-visible geometry from GameCenterView.swift and AppBackButton. */
